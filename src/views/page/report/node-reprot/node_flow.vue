            ...
            <div v-show="popOpen" class="app-container pop-body-diy">
                <form :model="queryParam" ref="queryParam1" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-md-3" style="color: #e5ecf3">节点名称：</label>
                        <div class="col-md-5">
                            <el-select v-model="nodeVal" placeholder="请选择">
                                <el-option
                                        v-for="item in nodes"
                                        :key="item.nodeId"
                                        :label="item.nodeName"
                    ...
                    <div class="form-group">
                        <label class="col-md-3" style="color: #e5ecf3">协议：</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="col-md-3" style="color: #e5ecf3">单位：</label>
                        <div class="col-md-5">
