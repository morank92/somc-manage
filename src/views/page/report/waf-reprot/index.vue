<template>
    <div class="app-container panel panel-default panel-diy">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="用户TOP" name="user">
            </el-tab-pane>
            <el-tab-pane label="节点TOP" name="node">
            </el-tab-pane>
        </el-tabs>
...
<script>
    ...
    const chart1 = resolve => require(['./user_top'],resolve);
    const chart2 = resolve => require(['./node_top'],resolve);
    ...
    export default {
        ...
        data() {//页面所需的数据
            return {
                "currentView":"user",//当前视图组件
                "activeName":"user",//tab当前高亮
            }
        },
        methods: {
